...
public class Level5 implements Level{
    private Shape levelBase, key, key2, door, door2, door3, spike, bimg;
    private FallingObj obj1;
    private Image k1, k2, d1, d2, d3, img, s;
    private ShapeRenderer sr;
    private Platform land, water, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12;
    ...
    public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
            ...
            p1 = new Platform(170, 350, 140, 50, pImg);
            p2 = new Platform(380, 550, 140, 50, pImg, VERTICAL, 450, 640);
            p3 = new Platform(650, 620, 140, 50, pImg);
            p4 = new Platform(1050, 250, 140, 50, pImg);
            p5 = new Platform(1100, 420, 140, 50, pImg); // 1st key
            p6 = new Platform(1200, 150, 150, 50, dImg);//main door
            p7 = new Platform(30, 150, 140, 50, pImg);//1st door
            p8 = new Platform(640, 398, 140, 50, pImg);// main key
            p9 = new Platform(900, 620, 140, 50, pImg);
            p10 = new Platform(800, 250, 140, 50, pImg, HORIZONTAL, 780, 840);
            p11 = new Platform(1150, 620, 140, 50, pImg);
            p12 = new Platform(250, 200, 140, 50, pImg, HORIZONTAL, 250, 500);
            land = new Platform(10, 620, 300, 70, landImg);
            
            water = new Platform(10, 683, 1344, 65, waterImg);
            key = new Rectangle(670, 330, 110, 90);
            key2 = new Rectangle(1080, 180, 110, 90);
            ...
            spike = new Rectangle(1130, 390, 90, 30);
    ...
    public void update(GameContainer gc, StateBasedGame sbg) throws SlickException {
        ...
        if (pWin){
            pWin = false;
            stop = true;
            ((Select)sbg.getState(2)).setCleared(true, 5);
            sound.stop();
            ((ClearedLevel) sbg.getState(-2)).setCurrentLvl(5);
        ...
        if (pDead){
            sound.stop();
            stop = true;
            ((FailedLevel) sbg.getState(-1)).setCurrentLvl(5);
    ...
    public void updateLastLevel(GameContainer gc, StateBasedGame sbg) throws SlickException {
    	...
    	if (pWin){
            ...
            ((Game) sbg.getState(3)).setLevel(6);
    ...
    public boolean collideMovingPlatform(Shape s){
    	return p2.intersects(s) || p10.intersects(s) || p12.intersects(s);
    }
